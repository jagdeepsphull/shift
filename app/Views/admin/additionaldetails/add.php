...
<?php /* No "<small>Detail</small>" after the title the way the other masters
   carry it - this one's title already ends in the word, and "Additional Detail
   Detail" is what that produced. */ ?>
                <h3 class="card-title"><?php echo $pageinfo['title']; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                  ...
                  <div class="row">
                    <div class="col-sm-4">
					  <div class="form-group">
						...
						<input type="text" class="form-control" id="ad_name" name="ad_name" placeholder="Enter Additional Detail" value="<?php echo $ad_name;?>" required>
					  </div>
					 </div>
