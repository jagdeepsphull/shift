<div id="section2" class="col-md-12 noPadding text-center">
    ...
    <img src="<?php echo base_url();?>/assets/front/img/shapegreen.png">
    <div class="col-md-12">
        <p class="col-md-8 col-md-offset-2 myTextMain">This is Photoshop's version of Lorem Ipsum. Proin gravida nibh
            vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec
    ...
    <div class="col-md-8 col-md-offset-2 backGroundImage">
        <div id="carousel-example-generic-main" class="carousel slide" data-ride="carousel">
            ...
            <a class="left carousel-control" href="#carousel-example-generic-main" role="button" data-slide="prev">
                <img class="img-responsive" src="<?php echo base_url();?>/assets/front/img/left-arrow.png">
                <span class="sr-only">Previous</span>
            </a>
            <a class="right carousel-control" href="#carousel-example-generic-main" role="button" data-slide="next">
                <img class="img-responsive" src="<?php echo base_url();?>/assets/front/img/right.png">
...
<div class="col-md-12 noPadding">
    ...
    <div class="abs text-center">
        ...
        <img src="<?php echo base_url();?>/assets/front/img/shape.png">
...
<div class="col-md-12 noPadding text-center">
    ...
    <img class="withBottom" src="<?php echo base_url();?>/assets/front/img/shapegreen.png">
</div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item carousel-item active">
                    <div class="img-box"><img src="<?php echo base_url();?>/assets/front/img/testimonial.png" alt="">
                    </div>
...
<div class="col-md-12 noPadding text-center backNewsletter">
    <div class="col-md-8 col-md-offset-2">
        <div class="row">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control myInputFooter" placeholder="Last Name"
            ...
            <div class="col-md-6 wow animated fadeInRight" data-wow-delay=".2s">
                <form class="shake" role="form" method="post" id="contactForm" name="contact-form"
                    ...
                    <div class="form-group label-floating">
                        ...
                        <input class="form-control myInputFooter" id="name" type="text" name="name" required
                    ...
                    <div class="form-group label-floating">
                        ...
                        <input class="form-control myInputFooter" id="email" type="email" name="email" required
                    ...
                    <div class="form-group label-floating">
                        ...
                        <input class="form-control myInputFooter" id="msg_subject" type="text" name="subject" required
                    ...
                    <div class="form-group label-floating">
                        ...
                        <textarea class="form-control myInputFooter" rows="3" id="message" name="message" required
