                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 owneronly">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" class="form-control" placeholder="Enter <?php echo $pageinfo['title']; ?> Name" name="u_comp_name" value="<?php echo esc($u_comp_name); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 storeonly">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  type="text" class="form-control" placeholder="Enter Store No." name="u_licence_no" value="<?php echo esc($u_licence_no); ?>">
                                        </div>
                                    </div>
                                </div>
