        ...
        <div class="container" id="home">      
          <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
              <div class="contents">
                <h2 class="head-title">Your valuable partner in excellent patient care</h2>
                <p>Empowering Pharmacies with skilled Professionals to provide enhanced quality care</p>
                <div class="header-button">
                  <a rel="nofollow" href="<?php echo base_url('contact') ; ?>#contact" class="btn btn-common">Contact Us</a>
                </div>
              </div>
            </div>
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
              <div class="intro-img">
                <img class="img-fluid" src="<?php echo base_url('assets/front/assets/img/intro-mobile.png'); ?>" alt="">
              </div>            
            </div>
          </div> 
        </div> 
