                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
											...
											<select  name="u_usersubtype" id="u_usersubtype" class="form-control" required>
                                ...
                                <div class="row">
									...
									<div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  required type="text" class="form-control" placeholder="Enter <?php echo $pageinfo['title']; ?> Mobile No." name="u_phone" value="<?php echo esc($u_phone); ?>">
                                        </div>
                                    </div>
