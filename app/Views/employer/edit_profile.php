	                    ...
	                    <div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-2">
	                            <div class="form-group">
									...
									<input required readonly disabled type="text" class="form-control" placeholder="Enter <?php echo $pageinfo['title']; ?> Name" name="u_comp_name" value="<?php echo $u_comp_name; ?>">
								</div>
	                        </div>
	                        <div class="col-lg-4 col-md-4 col-sm-2">
	                            <div class="form-group">
	                        ...
	                        <div class="col-lg-4 col-md-4 col-sm-2">
	                            <div class="form-group">
									...
									<input required readonly disabled type="text" class="form-control" placeholder="Enter Store No." name="u_licence_no" value="<?php echo $u_licence_no; ?>">
								</div>
	                        </div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input required type="email" readonly disabled class="form-control" placeholder="Enter Email Id" name="u_email" value="<?php echo $u_email; ?>">
								</div>
							</div>
							<div class="col-sm-4">
								<!-- text input -->
