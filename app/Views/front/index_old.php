              ...
              <div class="card-body table-responsive1 p-2" style="1height: 300px;">
                <table id="joblistH" class="table table-bordered table-striped datatablecss">
                  ...
                  <tr>
                    ...
                    <td><?php echo dateFormat($job->p_dates); ?></td>
          ...
          <div class="col-md-6 col-lg-4 col-xs-12">
            <div class="services-item wow fadeInRight" data-wow-delay="0.3s">
              ...
              <div class="services-content">
                ...
                <p align="justify">We can be reached with Phone call, Email or through our portal. Easily accessible, Always Ready (Once you Contact Us, We will understand your specific situation and recommend the best possible staffing solution. We help you grow your business with patient focused initiatives with highly qualified professionals
 </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 col-xs-12">
            <div class="services-item wow fadeInRight" data-wow-delay="0.6s">
              ...
              <div class="services-content">
                ...
                <p align="justify">All account Creation Requests, Whether it is from The Applicant or from The Employer, will be verified before the Account Activation & Approval</p>
              </div>
            </div>
          </div>
          <!-- Services item -->
