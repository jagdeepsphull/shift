                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" name="u_id" id="store_owner">
                                                ...
                                                <?php /* The kind is spelled out only when it is not an
                                                   Owner: an account from before the kinds reads
                                                   "Not set", and that is worth seeing while
                                                   choosing. Saying "(Owner)" against every other
                                                   row would only repeat the label above. */ ?>
                            ...
                            <div class="card-footer">
                                <input type="submit" name="savedata" class="btn btn-primary" value="Add Store" />
